...
export default function BabyNameSelector() {
  ...
  const [formState, formAction] = useActionState(updateSelectedNames, { selectedNames: [] })
  ...
  return (
    <div className="w-full">
      <div className="p-6 border-b">
          <h1 className="text-3xl font-bold mb-4 text-center">Baby Name Selector</h1>
      ...
      <div>
        ...
        <div className="overflow-y-auto p-4">
          <div className="grid grid-cols1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 2xl:grid-cols-8 gap-4">
        ...
        <div className="p-4 border-t bg-muted/50 flex justify-between items-center">
          ...
          <form action={formAction}>
            <input type="hidden" name="selectedNames" value={JSON.stringify(selectedNames)} />
